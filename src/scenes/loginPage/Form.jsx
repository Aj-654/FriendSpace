...
import { auth as firebaseAuth, db, storage } from "../../firebase.js"; // Rename auth
...
const Form = () => {
  ...
  const register = async (values, onSubmitProps) => {
    try {
      ...
      // If the user is successfully saved in MongoDB, proceed with Firebase registration
      if (savedUser) {
        ...
        // Get the user's UID from the Firebase user credential
        ...
        await updateProfile(firebaseUserCredential.user, {
          email,
  ...
  const login = async (values, onSubmitProps) => {
    try {
      ...
      // After successful authentication, you can retrieve the user details
      const firebaseUser = firebaseUserCredential.user;
  
      // Your existing logic to handle the response from your server
      ...
      if (loggedIn) {
        ...
        // Additional logic to check if MongoDB login is successful
      ...
      // You can also handle specific authentication error codes from Firebase
      // For example, if (error.code === "auth/user-not-found") { /* handle user not found */ }
    }
  };
